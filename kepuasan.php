      ...
      <form method="POST" action="">
        <div class="date-time-section">
          <div class="input-group">
            <label for="surveyDate"><span style="color:#00b3b3;margin-right:5px;">📅</span> Tanggal Survei</label>
            <input type="date" id="surveyDate" name="surveyDate" required>
          </div>
          <div class="input-group">
            <label for="surveyTime"><span style="color:#00b3b3;margin-right:5px;">⏰</span> Jam Survei</label>
