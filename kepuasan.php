...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($valid) {
    ...
    if ($result) {
      ...
      $error = "Gagal menyimpan data kepuasan.";
    }
  } else {
    $error = "Mohon lengkapi semua pertanyaan survei.";
  }
}
...
<body>
  <div class="container">
      ...
      <form method="POST" action="">
        ...
        <div class="form-row">
          <div class="form-field">
            ...
            <div class="radio-group">
              <div class="radio-option">
                <input type="radio" id="bpjs" name="penjamin" value="BPJS" required>
                <label for="bpjs">BPJS</label>
              </div>
              <div class="radio-option">
                <input type="radio" id="umum" name="penjamin" value="UMUM">
    ...
    <input type="hidden" name="q4" id="q4-hidden" value="">
  ...
  const q4Hidden = document.getElementById('q4-hidden');
  ...
  function disableQ4() {
    ...
    q4Hidden.value = 0; // nilai default untuk BPJS
  }
  ...
  function enableQ4() {
    ...
    q4Hidden.value = ''; // pakai nilai dari radio
  }
